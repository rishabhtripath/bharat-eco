        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 max-w-6xl">
          ...
          >
            <Input
              ...
              className="bg-sky-200 border border-sky-400 rounded-xl py-4 px-4 text-gray-900 placeholder:text-gray-600 focus:border-sky-500 focus:ring-2 focus:ring-sky-300"
            />
            ...
            <Textarea
              ...
              className="bg-sky-200 border border-sky-400 rounded-xl py-4 px-4 text-gray-900 placeholder:text-gray-600 focus:border-sky-500 focus:ring-2 focus:ring-sky-300 resize-none"
            />
